    ...
    <div className="home-container">
      ...
      <section className="conference-details">
        ...
        <h2 className="conference-subtitle">
          “Membrane Processes for a Green Environment: Current Status,
      ...
      <section className="about-conference">
        ...
        <p>
          The Indian Membrane Society organizes this conference annually to
          commemorate the Birth Anniversary of Prof. S. Sourirajan, a pioneer in
          Phase Inversion Membranes. This year, the event will take place at
          JNTUA, Anantapur, focusing on “Membrane Processes for a Green
          Environment: Current Status, Challenges, and Future Prospects.” The
          conference will offer a comprehensive look into membrane technologies
      ...
      <section className="image-section">
        ...
        <a
          href="https://drive.google.com/file/d/12Vg7hGdVfyxxXUnNaw8Sp0UE3UL9RXzk/view?usp=sharing"
          target="_blank"
          rel="noreferrer"
      ...
      <section className="topics">
        ...
        <div className="topics-table">
          ...
          <div className="topic">
            ...
            <p>
              Biological inventions and technologies for a green environment.
            </p>
          </div>
          <div className="topic">
          ...
          <div className="topic">
            <h4>Bio-Membranes</h4>
            <p>
              Bio-membranes, nanomaterials, nano composites, and
              nano-technology.
            </p>
          </div>
          <div className="topic">
          ...
          <div className="topic">
            ...
            <p>
              Membrane modification and characterization for green environment.
            </p>
          </div>
          <div className="topic">
      ...
      <section className="organizers-info">
        ...
        <div className="organizers-cards">
          <div className="organizer-card">
            ...
            <p>Baroda, India</p>
            <a
              href="http://www.indianmembranesociety.org"
              target="_blank"
          ...
          <div className="organizer-card">
            ...
            <br></br>
            <p>
              JNTUA College of Engineering <br></br>Ananthapuramu, India
            </p>
            <a
          ...
          <div className="address-card">
            ...
            />
            <p>
              JNTUA College of Engineering Ananthapuramu,<br></br>Andhra
      ...
      <footer className="footer">
        <p>
          &copy; {new Date().getFullYear()} JNTUA College of Engineering. All
          rights reserved.
        </p>
        <p className="developer-info">
          Developed with <span className="heart">&hearts;</span> by{" "}
          <a
            href="https://www.linkedin.com/in/dinesh-kuddana-198a0a243/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Dinesh Kuddana
